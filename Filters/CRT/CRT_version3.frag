//Ported from https://www.shadertoy.com/view/tt3yR2

// CRT EFFECTS HAPPEN HERE
...
void main( ) {
    ...
    if(max( abs(pos.x), abs(pos.y) )<1.0) {							// skip everything if we're beyond the screen edge
        ...
        #ifdef SHADOW_MASK
        vec3 shadowmask = SlotMask_PixelPerfect( gl_FragCoord.xy );
